...
console.log(toRetire); //All emploeesData to retire

const employeesToRetired = toRetire.map (employee => { //To save the names in an array
...
employeesToRetired.forEach((retiredEmployee) => {
  console.log(`Hey ${retiredEmployee}, congratulations on your retirement, your pension will begin asap.`)
});
...
console.log(array.every(el => el > 5));
